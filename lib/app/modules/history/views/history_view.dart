...
import 'package:booksphere/app/data/models/response_history_peminjaman.dart';
...
class HistoryView extends GetView<HistoryController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("History Book",style: TextStyle(color: Color(0xFFE33629)),),
      ...
      child: GestureDetector(
        ...
        child: Row(
          ...
          children: [
            ...
            const Expanded(child: Icon(Icons.history, color: Colors.black,size: 40,)),
            const Expanded(child: SizedBox()),
          ],
        ),
      ),
